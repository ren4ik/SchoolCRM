...
from Server.settings import ICONS_MAX_SIZE
...
def get_size_correction(width, height):
    ...
    if size_width > ICONS_MAX_SIZE or size_height > ICONS_MAX_SIZE:
        size_width = math.ceil(
            (size_width * (ICONS_MAX_SIZE / size_height)))
        size_height = ICONS_MAX_SIZE
